...
public class OperateElement{
	...
	public static void highLightElement( WebElement element){
		...
		js.executeScript("arguments[0].setAttribute('style', arguments[1]);", element, "background: blue; border:2px solid red;");
	 ...
	 * @param jsStr
	 */
	public static void executeJs(String jsStr){
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public static void fun(WebElement element){
		Actions actions = new Actions(driver);
		actions.moveToElement(element,5,5).click();
	}
	 ...
	 * @param yOffset 拖到目标的纵坐标位置
	 */
	public static void scrollH5(WebElement element,int xOffset,int yOffset) {
		//touchActions方法
		TouchActions tAction = new TouchActions(driver);
		tAction.scroll(element,xOffset,yOffset).perform();

	}


	public static void flick(WebElement element,int xOffset,int yOffset) {
		//touchActions方法
		TouchActions tAction = new TouchActions(driver);
		tAction.flick(element,xOffset,yOffset,20).perform();
	}
	 ...
	 * 拖动滚动条到页面底部
	 */
	public static void scrollIntoBottom(){
